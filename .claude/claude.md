...
- When implementing functionality, prefer to use libraries / frameworks where possible such as HugsLib to reduce manual implementation overhead. Make sure to search the RimWorld source code for proven patterns as a reference to achieve desired functionality as much as possible. Document common patterns for future quick reference.
