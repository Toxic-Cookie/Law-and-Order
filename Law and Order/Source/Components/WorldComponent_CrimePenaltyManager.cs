...
namespace LawAndOrder
{
    ...
    public class WorldComponent_CrimePenaltyManager : WorldComponent
    {
        ...
        private void InitializeDefaultCrimes()
        {
            ...
            crimeDefinitions.Add(new CrimeDefinition("Execution", "LawAndOrder_Crime_Execution".Translate(), "LawAndOrder_Crime_Execution_Desc".Translate(), CrimeSeverity.Critical, 5000, 10000, CrimeCategory.Lethal));
            crimeDefinitions.Add(new CrimeDefinition("VitalOrganDestruction", "LawAndOrder_Crime_VitalOrganDestruction".Translate(), "LawAndOrder_Crime_VitalOrganDestruction_Desc".Translate(), CrimeSeverity.Critical, 4000, 8000, CrimeCategory.Lethal));
            crimeDefinitions.Add(new CrimeDefinition("Murder", "LawAndOrder_Crime_Murder".Translate(), "LawAndOrder_Crime_Murder_Desc".Translate(), CrimeSeverity.Critical, 3000, 6000, CrimeCategory.Lethal));
            crimeDefinitions.Add(new CrimeDefinition("Kidnapping", "LawAndOrder_Crime_Kidnapping".Translate(), "LawAndOrder_Crime_Kidnapping_Desc".Translate(), CrimeSeverity.Critical, 2500, 5000, CrimeCategory.Lethal));
            ...
            crimeDefinitions.Add(new CrimeDefinition("ToxicGasDeployment", "LawAndOrder_Crime_ToxicGasDeployment".Translate(), "LawAndOrder_Crime_ToxicGasDeployment_Desc".Translate(), CrimeSeverity.High, 800, 1500, CrimeCategory.Environmental));
            crimeDefinitions.Add(new CrimeDefinition("PsychicAttack", "LawAndOrder_Crime_PsychicAttack".Translate(), "LawAndOrder_Crime_PsychicAttack_Desc".Translate(), CrimeSeverity.High, 600, 1200, CrimeCategory.Environmental));
            crimeDefinitions.Add(new CrimeDefinition("PsychicShock", "LawAndOrder_Crime_PsychicShock".Translate(), "LawAndOrder_Crime_PsychicShock_Desc".Translate(), CrimeSeverity.Moderate, 400, 800, CrimeCategory.Environmental));
            crimeDefinitions.Add(new CrimeDefinition("EMPAttack", "LawAndOrder_Crime_EMPAttack".Translate(), "LawAndOrder_Crime_EMPAttack_Desc".Translate(), CrimeSeverity.Moderate, 300, 600, CrimeCategory.Environmental));
            crimeDefinitions.Add(new CrimeDefinition("AcidBurns", "LawAndOrder_Crime_AcidBurns".Translate(), "LawAndOrder_Crime_AcidBurns_Desc".Translate(), CrimeSeverity.Moderate, 500, 1000, CrimeCategory.Environmental));
            crimeDefinitions.Add(new CrimeDefinition("ElectricalBurns", "LawAndOrder_Crime_ElectricalBurns".Translate(), "LawAndOrder_Crime_ElectricalBurns_Desc".Translate(), CrimeSeverity.Moderate, 400, 800, CrimeCategory.Environmental));

            // DISEASE & INFECTION CRIMES
            crimeDefinitions.Add(new CrimeDefinition("IntentionalPlagueInfection", "LawAndOrder_Crime_IntentionalPlagueInfection".Translate(), "LawAndOrder_Crime_IntentionalPlagueInfection_Desc".Translate(), CrimeSeverity.High, 1200, 2500, CrimeCategory.Disease));
            crimeDefinitions.Add(new CrimeDefinition("WoundInfection", "LawAndOrder_Crime_WoundInfection".Translate(), "LawAndOrder_Crime_WoundInfection_Desc".Translate(), CrimeSeverity.Moderate, 300, 600, CrimeCategory.Disease));
            crimeDefinitions.Add(new CrimeDefinition("ToxicBuildup", "LawAndOrder_Crime_ToxicBuildup".Translate(), "LawAndOrder_Crime_ToxicBuildup_Desc".Translate(), CrimeSeverity.Moderate, 400, 800, CrimeCategory.Disease));

            // PROPERTY CRIMES - DESTRUCTION
            crimeDefinitions.Add(new CrimeDefinition("Sapping", "LawAndOrder_Crime_Sapping".Translate(), "LawAndOrder_Crime_Sapping_Desc".Translate(), CrimeSeverity.High, 500, 1500, CrimeCategory.PropertyDestruction));
            crimeDefinitions.Add(new CrimeDefinition("Breaching", "LawAndOrder_Crime_Breaching".Translate(), "LawAndOrder_Crime_Breaching_Desc".Translate(), CrimeSeverity.High, 600, 1800, CrimeCategory.PropertyDestruction));
            crimeDefinitions.Add(new CrimeDefinition("DoorDestruction", "LawAndOrder_Crime_DoorDestruction".Translate(), "LawAndOrder_Crime_DoorDestruction_Desc".Translate(), CrimeSeverity.Moderate, 200, 500, CrimeCategory.PropertyDestruction));
            crimeDefinitions.Add(new CrimeDefinition("PowerGeneratorDestruction", "LawAndOrder_Crime_PowerGeneratorDestruction".Translate(), "LawAndOrder_Crime_PowerGeneratorDestruction_Desc".Translate(), CrimeSeverity.High, 800, 2000, CrimeCategory.PropertyDestruction));
            crimeDefinitions.Add(new CrimeDefinition("DefensiveStructureDestruction", "LawAndOrder_Crime_DefensiveStructureDestruction".Translate(), "LawAndOrder_Crime_DefensiveStructureDestruction_Desc".Translate(), CrimeSeverity.Moderate, 400, 1000, CrimeCategory.PropertyDestruction));
            crimeDefinitions.Add(new CrimeDefinition("BuildingDestruction", "LawAndOrder_Crime_BuildingDestruction".Translate(), "LawAndOrder_Crime_BuildingDestruction_Desc".Translate(), CrimeSeverity.Moderate, 300, 800, CrimeCategory.PropertyDestruction));
            crimeDefinitions.Add(new CrimeDefinition("CropDestruction", "LawAndOrder_Crime_CropDestruction".Translate(), "LawAndOrder_Crime_CropDestruction_Desc".Translate(), CrimeSeverity.Moderate, 200, 600, CrimeCategory.PropertyDestruction));

            // PROPERTY CRIMES - THEFT
            crimeDefinitions.Add(new CrimeDefinition("GrandTheft", "LawAndOrder_Crime_GrandTheft".Translate(), "LawAndOrder_Crime_GrandTheft_Desc".Translate(), CrimeSeverity.High, 1000, 5000, CrimeCategory.Theft));
            crimeDefinitions.Add(new CrimeDefinition("Theft", "LawAndOrder_Crime_Theft".Translate(), "LawAndOrder_Crime_Theft_Desc".Translate(), CrimeSeverity.Moderate, 320, 1000, CrimeCategory.Theft));
            crimeDefinitions.Add(new CrimeDefinition("PettyTheft", "LawAndOrder_Crime_PettyTheft".Translate(), "LawAndOrder_Crime_PettyTheft_Desc".Translate(), CrimeSeverity.Low, 100, 320, CrimeCategory.Theft));
            crimeDefinitions.Add(new CrimeDefinition("WeaponTheft", "LawAndOrder_Crime_WeaponTheft".Translate(), "LawAndOrder_Crime_WeaponTheft_Desc".Translate(), CrimeSeverity.High, 500, 2500, CrimeCategory.Theft));
            crimeDefinitions.Add(new CrimeDefinition("MedicineTheft", "LawAndOrder_Crime_MedicineTheft".Translate(), "LawAndOrder_Crime_MedicineTheft_Desc".Translate(), CrimeSeverity.High, 400, 2000, CrimeCategory.Theft));
            crimeDefinitions.Add(new CrimeDefinition("RelicTheft", "LawAndOrder_Crime_RelicTheft".Translate(), "LawAndOrder_Crime_RelicTheft_Desc".Translate(), CrimeSeverity.Critical, 3000, 10000, CrimeCategory.Theft));
            ...
            {
                crimeDefinitions.Add(new CrimeDefinition("ShamblerInfection", "LawAndOrder_Crime_ShamblerInfection".Translate(), "LawAndOrder_Crime_ShamblerInfection_Desc".Translate(), CrimeSeverity.High, 1500, 3000, CrimeCategory.Anomaly));
                crimeDefinitions.Add(new CrimeDefinition("VoidCorruption", "LawAndOrder_Crime_VoidCorruption".Translate(), "LawAndOrder_Crime_VoidCorruption_Desc".Translate(), CrimeSeverity.High, 1200, 2500, CrimeCategory.Anomaly));
                crimeDefinitions.Add(new CrimeDefinition("RevenantHypnosis", "LawAndOrder_Crime_RevenantHypnosis".Translate(), "LawAndOrder_Crime_RevenantHypnosis_Desc".Translate(), CrimeSeverity.High, 1000, 2000, CrimeCategory.Anomaly));
                crimeDefinitions.Add(new CrimeDefinition("Inhumanization", "LawAndOrder_Crime_Inhumanization".Translate(), "LawAndOrder_Crime_Inhumanization_Desc".Translate(), CrimeSeverity.Critical, 2000, 4000, CrimeCategory.Anomaly));
                crimeDefinitions.Add(new CrimeDefinition("MetalhorrorImplant", "LawAndOrder_Crime_MetalhorrorImplant".Translate(), "LawAndOrder_Crime_MetalhorrorImplant_Desc".Translate(), CrimeSeverity.High, 1500, 3000, CrimeCategory.Anomaly));
                crimeDefinitions.Add(new CrimeDefinition("BloodRageInduction", "LawAndOrder_Crime_BloodRageInduction".Translate(), "LawAndOrder_Crime_BloodRageInduction_Desc".Translate(), CrimeSeverity.Moderate, 600, 1200, CrimeCategory.Anomaly));
                crimeDefinitions.Add(new CrimeDefinition("FleshDevouring", "LawAndOrder_Crime_FleshDevouring".Translate(), "LawAndOrder_Crime_FleshDevouring_Desc".Translate(), CrimeSeverity.Critical, 2500, 5000, CrimeCategory.Anomaly));
            }

            // BIOTECH-SPECIFIC CRIMES (DLC)
            if (ModsConfig.BiotechActive)
            {
                crimeDefinitions.Add(new CrimeDefinition("BloodfeederAttack", "LawAndOrder_Crime_BloodfeederAttack".Translate(), "LawAndOrder_Crime_BloodfeederAttack_Desc".Translate(), CrimeSeverity.Moderate, 400, 800, CrimeCategory.Biotech));
                crimeDefinitions.Add(new CrimeDefinition("MechSwarmAttack", "LawAndOrder_Crime_MechSwarmAttack".Translate(), "LawAndOrder_Crime_MechSwarmAttack_Desc".Translate(), CrimeSeverity.High, 1000, 2000, CrimeCategory.Biotech));
                crimeDefinitions.Add(new CrimeDefinition("WastpackMortar", "LawAndOrder_Crime_WastpackMortar".Translate(), "LawAndOrder_Crime_WastpackMortar_Desc".Translate(), CrimeSeverity.High, 800, 1600, CrimeCategory.Biotech));
            }
        }
